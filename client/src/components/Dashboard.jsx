        ...
        <Layout>
            <div className={`p-8 transition-all duration-500 ease-in-out relative ${showModal ? "blur-sm pointer-events-none" : ""}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <NetWorthCard budget={totalBudget} expense={totalExpense} />
                </div>
                ...
                <div className="flex flex-col space-y-4 mt-16">
                    ...
                    <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">
                        ₹{totalExpense !== undefined && totalExpense !== null ? totalExpense.toLocaleString() : "0"} spent out of ₹{totalBudget !== undefined && totalBudget !== null ? totalBudget.toLocaleString() : "0"}
                    </p>
                </div>
                ...
                {/* Recent Transactions */}
                {/* <div className="mt-16">
                    <h4 className="text-xl font-semibold mb-6">Transaction History</h4>
                ...
                {/* Savings */}
                {/* <div className="mt-16">
                    <h4 className="text-xl font-semibold mb-4">Savings</h4>
